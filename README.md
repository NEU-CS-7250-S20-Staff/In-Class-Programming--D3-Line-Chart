...
1. Open `index.html`. Just below this HTML comment:
    ```html
    <!-- Load the d3.js library (version 5 minified) -->
    ```
    add this line to load the D3 javascript code (note the version number v5. D3 has many versions and they are not compatible.):
    ```html
